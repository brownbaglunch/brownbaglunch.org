  ...
  - tags:
    ...
    versions:
      - label: "FR"
        ...
        abstract: "MPA, SPA, statique, dynamique, cache, services tiers… tout ça est bien compliqué, et on s’y perd. Et si, à la place, on utilisait une métaphore filée pour bien comprendre l’état du Web aujourd’hui ?"
  - tags:
      - "code-du-travail"
      - "formation-continue"
    versions:
...
Strategic Consultant - Contentsquare
